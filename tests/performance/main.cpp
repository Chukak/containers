...
int main()
{
	...
	sorted_list_perf.add_actions(SortedListPerfomance::INSERT, SortedListPerfomance::DELETE, SortedListPerfomance::CLEAR, SortedListPerfomance::CLEAR);
	sorted_list_perf.run();

	BinarySearchTreePerfomance binary_search_tree_perf;
	binary_search_tree_perf.set_number(1'000'000);
	binary_search_tree_perf.add_actions(BinarySearchTreePerfomance::INSERT, BinarySearchTreePerfomance::DELETE, BinarySearchTreePerfomance::CLEAR, BinarySearchTreePerfomance::SEARCH);
