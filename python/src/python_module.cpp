...
BOOST_PYTHON_MODULE(LIBRARY_NAME)
{
    ...
    class_<Stack<object>, boost::noncopyable>("stack", init<>())
        ...
        .add_property("count",
                      +[](Stack<object>* p) -> unsigned int { return p->count(); },
        ...
        .add_property("is_empty",
                      +[](Stack<object>* p) -> bool { return p->is_empty(); },
    ...
    class_<Queue<object>, boost::noncopyable>("queue", init<>())
        ...
        .add_property("count",
                      +[](Queue<object>* p) -> unsigned int { return p->count(); },
        ...
        .add_property("is_empty",
                      +[](Queue<object>* p) -> bool { return p->is_empty(); },
    ...
    class_<bst<object>, boost::noncopyable>("bst", init<>())
        ...
        .add_property("count",
                      +[](bst<object>* p) -> unsigned int { return p->count(); },
                      "Return number of elements of the tree.")
        .add_property("is_empty",
                      +[](bst<object>* p) -> bool { return p->is_empty(); },
