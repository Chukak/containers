...
class StaticArray
{
    static_assert(std::disjunction_v<std::is_default_constructible<T>, std::is_nothrow_default_constructible<T>>,
  ...
  public:
     ...
     * @endcode
     */
    template<typename... Args, std::enable_if_t<std::conjunction_v<std::is_same<T, Args>...>>* = nullptr>
     ...
     */
    constexpr inline std::size_t count() const noexcept { return _count; }
    /**
     ...
     */
    constexpr inline std::size_t capacity() const noexcept { return _capacity; }
    /**
 ...
 */
template<typename T, std::size_t Size>
constexpr StaticArray<T, Size>::StaticArray() noexcept : _data{T{}}, _capacity{Size}, _count{0}
{}
/*
 ...
 */
template<typename T, std::size_t Size>
template<typename... Args, std::enable_if_t<std::conjunction_v<std::is_same<T, Args>...>>*>
constexpr StaticArray<T, Size>::StaticArray(Args&&... list) noexcept : _data{T{}}, _capacity{Size}, _count{Size}
{
